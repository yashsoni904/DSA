<h2><a href="https://leetcode.com/problems/restore-finishing-order/">3668. Restore Finishing Order</a></h2><h3>Easy</h3><hr><p>You are given an integer array <code>order</code> of length <code>n</code> and an integer array <code>friends</code>.</p>
